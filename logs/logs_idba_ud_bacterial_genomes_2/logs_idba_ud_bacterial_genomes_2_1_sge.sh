...
#$ -v TMPDIR=/data
# Your job name
#$ -N logs_idba_ud_bacterial_genomes_2
#
# Shell Environment
#$ -S /bin/bash
#
...
#$ -o logs_idba_ud_bacterial_genomes_2
#$ -e logs_idba_ud_bacterial_genomes_2
#
...
/nfs1/MICRO/Thurber_Lab/local/bin/idba/bin/idba_ud -l /raid1/home/micro/klingesj/grace/Rickettsiales/bowtie/conc_pair_rick_merged.fa --num_threads 10 -o rick1_bacterial2_idba_ud_out
