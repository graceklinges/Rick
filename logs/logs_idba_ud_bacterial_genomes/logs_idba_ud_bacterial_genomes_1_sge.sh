...
#$ -v TMPDIR=/data
# Your job name
#$ -N logs_idba_ud_bacterial_genomes
#
# Shell Environment
#$ -S /bin/bash
#
...
#$ -o logs_idba_ud_bacterial_genomes
#$ -e logs_idba_ud_bacterial_genomes
#
...
/nfs1/MICRO/Thurber_Lab/local/bin/idba/bin/idba_ud -l /raid1/home/micro/klingesj/grace/Rickettsiales/bowtie/conc_pair_rick_merged.fa --mink 60 --maxk 124 --num_threads 10 -o rick1_bacterial_idba_ud_out
