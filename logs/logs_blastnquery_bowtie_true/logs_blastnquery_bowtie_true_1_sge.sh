...
#$ -v TMPDIR=/data
# Your job name
#$ -N logs_blastnquery_bowtie_true
#
# Shell Environment
#$ -S /bin/bash
#
...
#$ -o logs_blastnquery_bowtie_true
#$ -e logs_blastnquery_bowtie_true
#
...
/local/cluster/ncbi-blast-2.2.31+-rpsbproc/bin/blastn -db /raid1/home/micro/klingesj/grace/Rickettsiales/Refseq/bowtie_complete_bacteria_genomes -evalue 10e-20 -outfmt 6 -num_threads 10 -max_target_seqs 1 -query /raid1/home/micro/klingesj/grace/Rickettsiales/bowtie/conc_pair_rick_merged_true.fa -out /raid1/home/micro/klingesj/grace/Rickettsiales/blastnquery_bowtie_true
