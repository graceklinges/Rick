...
makeblastdb -in /raid1/home/micro/klingesj/labhome/databases/NCBI_ref_seq_db/bacteria_genomes_2017.fna -input_type fasta -title bacteria_genomes -dbtype nucl
